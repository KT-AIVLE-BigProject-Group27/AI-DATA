...
from threshold_settings import find_threshold, find_all_thresholds
...
for model_label, get_model_fn in models_info:
    ...
    # thresholds = find_all_thresholds(model, train_loader, val_loader, use_train=False, device="cuda")
